...
@Component({
    selector: 'app-activity-tag-input',
    templateUrl: './activity-tag-input.component.html',
    styleUrls: ['./activity-tag-input.component.scss'],
    standalone: false
})
export class ActivityTagInputComponent implements OnInit, OnDestroy {
  ...
  constructor(private activityTagRepository: PetActivityTagRepositoryService) {
  }
