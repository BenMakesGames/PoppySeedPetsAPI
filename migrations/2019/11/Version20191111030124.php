 ...
 */
final class Version20191111030124 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE pet ADD CONSTRAINT FK_E4529B858F7B22CC FOREIGN KEY (tool_id) REFERENCES inventory (id) ON DELETE SET NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE pet DROP FOREIGN KEY FK_E4529B858F7B22CC');
        $this->addSql('ALTER TABLE pet DROP FOREIGN KEY FK_E4529B858C6A5980');
        $this->addSql('ALTER TABLE pet ADD CONSTRAINT FK_E4529B858F7B22CC FOREIGN KEY (tool_id) REFERENCES inventory (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
