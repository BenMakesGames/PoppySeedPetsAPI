 ...
 */
final class Version20190622143921 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE item ADD size INT NOT NULL');
        $this->addSql('ALTER TABLE user DROP max_inventory, DROP max_pets');
    }
}
