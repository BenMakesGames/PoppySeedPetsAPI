 ...
 */
final class Version20190727175822 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE park_event (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(40) NOT NULL, seats INT NOT NULL, ran_on DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
