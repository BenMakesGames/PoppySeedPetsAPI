...
final class Version20260308152646 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        -- the item itself!
        INSERT INTO item (`id`, `name`, `description`, `image`, `use_actions`, `tool_id`, `food_id`, `fertilizer`, `plant_id`, `hat_id`, `fuel`, `recycle_value`, `enchants_id`, `spice_id`, `treasure_id`, `is_bug`, `hollow_earth_tile_card_id`, `cannot_be_thrown_out`, `museum_points`) VALUES (1516,"Khachapuri",NULL,"meal/khachapuri",NULL,NULL,541,12,NULL,NULL,0,0,NULL,NULL,NULL,0,NULL,0,1) ON DUPLICATE KEY UPDATE `id` = `id`;
        
        -- grammar
        INSERT INTO item_grammar (`id`, `item_id`, `article`) VALUES (1596,1516,"a") ON DUPLICATE KEY UPDATE `id` = `id`;
        EOSQL);
    }
