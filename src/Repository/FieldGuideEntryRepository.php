...
/**
 * @method FieldGuideEntry|null find($id, $lockMode = null, $lockVersion = null)
...
class FieldGuideEntryRepository extends ServiceEntityRepository
{
    ...
    {
        parent::__construct($registry, FieldGuideEntry::class);
    }

    public function findOneByName(string $name): ?FieldGuideEntry
    {
