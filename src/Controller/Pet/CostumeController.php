...
class CostumeController
{
    ...
    ): JsonResponse
    {
        ...
        PetBadgeHelpers::awardBadgeAndLog($em, $pet, PetBadgeEnum::WasGivenACostumeName, ActivityHelpers::UserName($user, true) . ' gave ' . ActivityHelpers::PetName($pet) . '\'s Halloween costume a name.');
