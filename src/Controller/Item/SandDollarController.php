 ...
 */
class SandDollarController extends PsyPetsItemController
{
    /**
    ...
    )
    {
        ...
        $inventoryService->receiveItem('Silica Grounds', $user, $user, $user->getName() . ' found this inside a Sand Dollar.');
        ...
        {
            $inventoryService->receiveItem('Talon', $user, $user, $user->getName() . ' found this inside a Sand Dollar.');
        ...
        {
            $inventoryService->receiveItem('Mermaid Egg', $user, $user, $user->getName() . ' found this inside a Sand Dollar.');
        ...
        {
            $inventoryService->receiveItem('Plastic', $user, $user, $user->getName() . ' found this inside a Sand Dollar.');
        ...
        {
            $inventoryService->receiveItem('Iron Key', $user, $user, $user->getName() . ' found this inside a Sand Dollar.');
