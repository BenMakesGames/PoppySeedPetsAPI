...
class MilkBookController
{
    ...
    ): JsonResponse
    {
        ...
        ItemControllerHelpers::validateInventoryAllowingLibrary($user, $inventory, 'milkBook/#/upload');
    ...
    {
        ItemControllerHelpers::validateInventoryAllowingLibrary($userAccessor->getUserOrThrow(), $inventory, 'milkBook/#/read');
