...
class PlayerStatsCommand extends PoppySeedPetsCommand
{
    ...
    protected function doCommand()
    {
        ...
        $data = [
            ...
            'Activity in the Last 3 Days' => $this->getCount($activityQuery, $now->modify('-36 hours')->format('Y-m-d H:i:s')),
            ...
            'New Users in the Last 3 Days' => $this->getCount($newUsersQuery, $now->modify('-36 hours')->format('Y-m-d H:i:s')),
