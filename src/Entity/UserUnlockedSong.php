...
#[ORM\Table]
#[ORM\UniqueConstraint(name: 'user_id_song_id_idx', columns: ['user_id', 'song_id'])]
#[ORM\Entity]
class UserUnlockedSong
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\ManyToOne(targetEntity: User::class, inversedBy: 'unlockedSongs')]
