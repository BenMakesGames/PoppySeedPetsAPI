...
final class PetBadgeEnum
{
    ...
    public const CREATED_SENTIENT_BEETLE = 'createdSentientBeetle'; // TODO: code it; create graphic
    public const MET_THE_FLUFFMONGER = 'fluffmonger'; // TODO: code it; create graphic
    public const OUTSMARTED_A_THIEVING_MAGPIE = 'outsmartedAThievingMagpie'; // TODO: code it; create graphic
    public const FOUND_CETGUELIS_TREASURE = 'foundCetguelisTreasure'; // TODO: create graphic
    public const HAD_A_BABY = 'parent'; // TODO: code it; create graphic
