...
class HolidayEnum
{
    ...
    public const SNOW_MOON = 'Snow Moon';
    public const WORM_MOON = 'Worm Moon';
    public const PINK_MOON = 'Pink Moon';
    public const FLOWER_MOON = 'Flower Moon';
    public const STRAWBERRY_MOON = 'Strawberry Moon';
    public const BUCK_MOON = 'Buck Moon';
    public const STURGEON_MOON = 'Sturgeon Moon';
    public const CORN_MOON = 'Corn Moon';
    public const HUNTERS_MOON = 'Hunter\'s Moon';
    public const BEAVER_MOON = 'Beaver Moon';
    public const COLD_MOON = 'Cold Moon';
}